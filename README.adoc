...
https://foojay.io/almanac/jdk-11/[Java 11] is required to run drain-java.
...
- [ ] More documentation
- [ ] Implement _tail follow_ mode (currently in drain mode the whole file is read and stops once finished)
- [ ] In drain mode dump clusters on exit (e.g. for example when hitting `ctrl`+`c`)
